...
urlpatterns = [
    ...
    url('^v1/transactions/out/address/(?P<address>[13][a-km-zA-HJ-NP-Z1-9]{26,33})', GetAddressTxOutsView.as_view()),
    url('^v1/transactions/in/address/(?P<address>[13][a-km-zA-HJ-NP-Z1-9]{26,33})', GetAddressTxInsView.as_view()),
