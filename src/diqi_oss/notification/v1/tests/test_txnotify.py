...
from diqi_oss.notification.daemon import TxNotifyDaemon
from diqi_oss.notification.models import TxNotification, TxSubscription
...
class TxNotifyDaemonTestCase(TestCase):
    ...
    @mock.patch('diqi_oss.notification.daemon.TxNotifyDaemon.get_transaction')
    @mock.patch('diqi_oss.notification.daemon.TxNotifyDaemon.get_best_block')
    @mock.patch('diqi_oss.notification.daemon.TxNotifyDaemon.start_notify')
