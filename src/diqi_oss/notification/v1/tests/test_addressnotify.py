...
from diqi_oss.notification.daemon import AddressNotifyDaemon
from diqi_oss.notification.models import AddressNotification, AddressSubscription, LastSeenBlock
...
class AddressNotifyDaemonTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = mock.patch('diqi_oss.notification.daemon.get_rpc_connection')
        self.patcher.start()
    ...
    @mock.patch('diqi_oss.notification.daemon.AddressNotifyDaemon.get_block')
    @mock.patch('diqi_oss.notification.daemon.AddressNotifyDaemon.get_best_block')
    @mock.patch('diqi_oss.notification.daemon.AddressNotifyDaemon.get_last_seen_block')
    ...
    @mock.patch('diqi_oss.notification.daemon.AddressNotifyDaemon.get_transaction')
    ...
    @mock.patch('diqi_oss.notification.daemon.ioloop.IOLoop.instance')
    @mock.patch('diqi_oss.notification.daemon.AsyncHTTPClient')
